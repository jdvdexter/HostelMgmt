		 ...
		 $ret= mysql_query("SELECT * FROM userregistration where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
				...
				<tr>
                    <td width="12%" valign="top" class="heading">Allotment ID: </td>
...
<tr>
                    <td width="12%" valign="top" class="heading">Furniture: </td>
                      <td class="comb-value1"><?php if($row['furniture']==0)
{
  echo "Without Almirah,Desk";
}
else
{
  echo "With Almirah,Desk";
}
                      ;?></td>
                    </tr>                
...
<td class="comb-value1"><?php echo $row['state'];?></td>
</tr>
